      ...
      <Navbar collapseOnSelect fixed="top" className="navbar-custom" expand="lg">
        ...
        <Navbar.Collapse id="basic-navbar-nav">
          <Nav className="ml-auto">
            ...
            <NavDropdown alignRight title={<span className="nav-text">People</span>} id="basic-nav-dropdown">
              <NavDropdown.Item href="#board"><span className="nav-text">Executive Board</span></NavDropdown.Item>
              <NavDropdown.Item href="#teams"><span className="nav-text">Teams</span></NavDropdown.Item>
            </NavDropdown>
